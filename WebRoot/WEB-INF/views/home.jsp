...
<html>
	...
	<body class="index">
		...
		<div class="fold hero index">
			<div class="phone">
				<iframe src="http://localhost:8080/apptry/screen#1" scrolling="no" frameborder="no"
					style="height: 788px; width: 525px;">
				</iframe>
				<!--  
				<iframe src="http://210.14.159.245/apptry/screen#1" scrolling="no" frameborder="no"
					style="height: 788px; width: 525px;">
				</iframe>
				-->
			</div>
			<div class="container">
				<div class="jumbotron" style="background-color:transparent;">
					<div class="benefit">
						...
						<button class="btn btn-lg" disabled>体验ZAKER</button>
						<a class="btn btn-lg btn-success" href="calculator#now" style="margin-left: 20px;">体验计算器</a>
					</div>
				</div>
			</div>
		</div>
		...
		<div id="howto" class="fold use-case gray">
			<div class="container">
				...
				<div class="sub-info">
					<p>1. App开发者上传.apk文件；</p>
					<p>2. Apptry反馈一段HTML代码(iframe)；</p>
					<p>3. App开发者将HTML代码嵌入到任意页面(需支持HTML5)发布即可。</p>
				</div>				
			</div>
		</div>
